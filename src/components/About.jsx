...
const About = () => {
  return (
    <section id='about' className="flex flex-col mt-20 mb-10 md:flex-row" data-aos='fade-up' data-aos-delay='400'>
      ...
      <div className="w-full md:w-3/5">
        <div className={`${styles.paddingX} relative p-4`}>
          ...
          <div className="flex flex-wrap mt-4 -mx-1" data-aos='fade-right' data-aos-delay='500'>

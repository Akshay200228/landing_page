...
const Hero = () => {
  return (
    <section id="home" className={`mt-20 mb-16 flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexCenter} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-col items-center justify-center w-full'>
          ...
          <button className="relative flex items-center px-6 py-3 mt-6 text-sm font-semibold text-white rounded-full animate-bounce bg-gradient-to-r from-sky-500 to-green-500 hover:from-sky-600 hover:to-green-600">
            Try for Free
